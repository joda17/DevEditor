...
DevEditor.prototype.setPosition = function(pos){
	...
	boxes[BOXTYPE.EDITOR].style.animation = "2s cubic-bezier(0.68,-0.55,0.27,1.55) 0s normal none infinite running editor-to-" + dir;
	boxes[BOXTYPE.NAVBAR].style.animation = "2s cubic-bezier(0.68,-0.55,0.27,1.55) 0s normal none infinite running navbar-to-" + dir;
	var t = this;
	setTimeout(function(){
